      ...
      <div className='bg-white p-12 rounded-md text-center border-gray-200 border space-y-6'>
        ...
        <Form.Root className="flex flex-col space-y-6 w-80">
          ...
          <div>
            ...
            <Link href="/company-register" className="flex justify-center mt-4 hover:bg-emerald-950 hover:text-white duration-300 w-full px-4 py-2 border-2 border-emerald-950 bg-white text-gray-600  font-semibold tracking-wider rounded-md">
              Cadastrar
            </Link>
          </div>
        </Form.Root>
